                    ...
                    <form action="{{ route('register.update', $user->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="id"
                                value="{{ 'ID' . sprintf('%03d', $user->id) }}" disabled>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('jabatan') is-invalid @enderror" id="jabatan"
                                ...
                                <option value="Bendahara DKM"
                                    {{ old('jabatan', $user->jabatan) == 'Bendahara DKM' ? 'selected' : '' }}>
                                    Bendahara DKM</option>
                                <option value="Koordinator Bidang Pemberdayaan ZISWAF"
                                    {{ old('jabatan', $user->jabatan) == 'Koordinator Bidang Pemberdayaan ZISWAF' ? 'selected' : '' }}>
                                    Koordinator Bidang Pemberdayaan ZISWAF</option>
                                <option value="Ketua DKM"
                                    {{ old('jabatan', $user->jabatan) == 'Ketua DKM' ? 'selected' : '' }}>
                                    Ketua DKM</option>
                            </select>
                            @error('jabatan')
                            <div class="invalid-feedback">{{ $message }}</div>
