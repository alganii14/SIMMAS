            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('pengeluaran.update', $pengeluaran->id) }}" method="POST">
                        ...
                        <!-- Nomor Pengajuan (Readonly) -->
                        <div class="form-group">
                            <label for="no_pengajuan">Nomor Pengajuan</label>
                            <input type="text" name="no_pengajuan" id="no_pengajuan" class="form-control" value="{{ $pengeluaran->no_pengajuan }}" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_koordinator" id="nama_koordinator" class="form-control @error('nama_koordinator') is-invalid @enderror" value="{{ old('nama_koordinator', $pengeluaran->nama_koordinator) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select name="koordinator_bidang" id="koordinator_bidang" class="form-control @error('koordinator_bidang') is-invalid @enderror" required>
                                ...
                                @foreach($koordinatorBidangOptions as $option)
                                    <option value="{{ $option }}" {{ old('koordinator_bidang', $pengeluaran->koordinator_bidang) == $option ? 'selected' : '' }}>{{ $option }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis_pengeluaran" id="jenis_pengeluaran" class="form-control @error('jenis_pengeluaran') is-invalid @enderror" required>
                                ...
                                @foreach($jenisPengeluaranOptions as $option)
                                    <option value="{{ $option }}" {{ old('jenis_pengeluaran', $pengeluaran->jenis_pengeluaran) == $option ? 'selected' : '' }}>{{ $option }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="jumlah" id="jumlah" class="form-control @error('jumlah') is-invalid @enderror" value="{{ old('jumlah', $pengeluaran->jumlah) }}" required>
                            @error('jumlah')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="keterangan" id="keterangan" rows="4" class="form-control @error('keterangan') is-invalid @enderror" required>{{ old('keterangan', $pengeluaran->keterangan) }}</textarea>
                            @error('keterangan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
