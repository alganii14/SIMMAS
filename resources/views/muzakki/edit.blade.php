        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Form Edit Muzakki</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('muzakki.update', $muzakki->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="no_muzakki"
                                value="{{ $muzakki->no_muzakki }}" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_muzakki" 
                                ...
                                id="nama_muzakki" value="{{ old('nama_muzakki', $muzakki->nama_muzakki) }}" required>
                            @error('nama_muzakki')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="telp_muzakki" 
                                ...
                                id="telp_muzakki" value="{{ old('telp_muzakki', $muzakki->telp_muzakki) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="alamat_muzakki" 
                                ...
                                id="alamat_muzakki" rows="3" 
                                required>{{ old('alamat_muzakki', $muzakki->alamat_muzakki) }}</textarea>
